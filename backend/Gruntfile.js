...
module.exports = function (grunt) {
    ...
    var taskConfig = {
        ...
        jshint: {
            src: [
                '<%= app_files.js %>', '!public/common/plugins/**/*.js'
            ],
            test: [
                '<%= app_files.jsunit %>'
            ],
    ...
    grunt.registerTask('watch', [ 'build', 'karma:unit', 'express:default', 'delta' ]);
    ...
    grunt.registerMultiTask('index', 'Process index.html template', function () {
        ...
        grunt.file.copy('public/index.html', this.data.dir + '/index.html', {
